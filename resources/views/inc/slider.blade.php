<div id="homeSlider" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="/products/images1.jpg" class="d-block w-100" alt="Slider Image 1">
        </div>
        <div class="carousel-item">
            <img src="/products/images2.jpg" class="d-block w-100" alt="Slider Image 2">
        </div>
        <div class="carousel-item">
            <img src="/products/images3.jpg" class="d-block w-100" alt="Slider Image 3">
        </div>
    </div>
